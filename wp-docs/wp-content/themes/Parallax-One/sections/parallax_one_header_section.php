<!-- CONTAINER -->
<?php
	$paralax_one_header_logo = get_theme_mod('paralax_one_header_logo', parallax_get_file('logo.jpg'));
	$parallax_one_header_title = get_theme_mod('parallax_one_header_title','7 savaičių </br>savęs pažinimo programa');
	$parallax_one_header_subtitle = get_theme_mod('parallax_one_header_subtitle','<ul>Reveal your career potential Find out your strengths and motivations Be guided by carefully selected methods <li>7-week online program for only 147 USD</li></ul>');
	...
	if( !empty($parallax_one_enable_move) && $parallax_one_enable_move ) {
		...
		echo '<ul id="parallax_move">';
			...
			if ( empty($parallax_one_first_layer) && empty($parallax_one_second_layer) ) {
				...
				echo '<li class="layer layer1" data-depth="0.10" style="background-image: url("http://talentukarta.eu/blog/wp-content/uploads/2016/01/titil-1.jpg");"></li>';
		...
		<div class="overlay-layer-wrap">
			...
			<?php
				if( !empty($paralax_one_header_logo) ){
					echo '<div class="only-logo"><div id="only-logo-inner" class="navbar"><div id="parallax_only_logo" class="navbar-header"></br></br></div></div></div>';
						...
						<div id="intro-section" class="intro-section">
							...
							<?php
								if( !empty($parallax_one_header_title) ){
									echo '<h1 id="intro_section_text_1" class="intro white-text">7 savaičių </br>savęs pažinimo programa</h1>';
								} elseif ( isset( $wp_customize )   ) {
							...
							<?php
								if( !empty($parallax_one_header_subtitle) ){
									echo '<h5 id="intro_section_text_2" class="white-text"></br><p>• Atrask savo vidinius norus</p><p>• Sužinok, ką gali daryti geriausiai</p><p>• Išmok motyvuoti save ir panaudoti savo potencialą</p><p>• Dalyvauk nuotolinėje 7 savaičių programoje</p></h5>';
								} elseif ( isset( $wp_customize )   ) {
									echo '<div id="intro_section_text_2" class="white-text paralax_one_only_customizer"></div>';
								}
							?>
