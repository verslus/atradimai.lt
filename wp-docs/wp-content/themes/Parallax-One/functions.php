...
function parallax_one_setup() {
	...
	add_image_size( 'parallax-one-post-thumbnail-big', 150, 150, true );
	add_image_size( 'parallax-one-post-thumbnail-mobile', 150, 150, true );
	add_image_size( 'the_post_thumbnail', 150, 150, true );
